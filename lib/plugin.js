...
async function getHeaders (ctx, stateless = true, headers = {}) {
...
export default async (ctx, inject) => {
  ...
  options.auth.headers = await getHeaders(ctx, options.auth.stateless, options.auth.headers || {})
